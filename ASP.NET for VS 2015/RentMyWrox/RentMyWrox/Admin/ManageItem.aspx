...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="dataentry">
	        ...
	        <asp:RequiredFieldValidator ID="rfItemNumber" ControlToValidate="tbItemNumber" runat="server"
                   ErrorMessage="Item Number is Required" Text="*" Display="Dynamic"/>
        </div>
        <div class="dataentry">
        ...
        <div class="dataentry">
            ...
            <asp:RequiredFieldValidator ID="rfAcquiredDate" ControlToValidate="tbAcquiredDate" runat="server"
                   ErrorMessage="Acquired Date is Required" Text="*" Display="Dynamic"/>
